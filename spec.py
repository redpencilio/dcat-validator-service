...
SHACL_BASE_URL = (
    "https://raw.githubusercontent.com/mobilityDCAT-AP/mobilityDCAT-AP/gh-pages"
)
...
if MOBILITY_DCAT_AP_VERSION == "1.1.0":
    ...
    SHACL_FILES = [
        ...
        # "/releases/1.1.0/shaclShapes/mobilitydcat-ap_1.1.0_shacl_mdr-vocabularies.shape.ttl" # This is done via python scripts now
    ]
